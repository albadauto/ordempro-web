...
import { ServiceOrderListDelivered } from './pages/service-order-list-delivered/service-order-list-delivered';
...
export const routes: Routes = [
  ...
  { path: 'services-order/list-delivered', component: ServiceOrderListDelivered, canActivate: [authGuard] },
];
